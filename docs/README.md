...
|---|---|---|
| [`PROJECT/PRD.md`](PROJECT/PRD.md) | Proposed 1.4 — D-032 | Product problem, free-form missions, mission-scoped environments, 59-identity organization, executive control, and contextual capabilities |
